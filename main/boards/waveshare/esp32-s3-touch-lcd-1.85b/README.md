...
See `REACTION_ASSETS.md` for private/custom gesture sounds and asset-pack
updates.

Physical audio quality, sensor thresholds, battery behavior and optional camera
orientation still require hardware-in-the-loop validation on the actual board
and final enclosure.
